...
public class FCEntityItemBloodWoodSapling extends EntityItem implements FCIEntityPacketHandler
{
    ...
    public Packet GetSpawnPacketForThisEntity()
    {
        ...
        try
        {
            ...
            var2.writeInt(this.item.itemID);
            var2.writeInt(this.item.stackSize);
            var2.writeInt(this.item.getItemDamage());
    ...
    public void CheckForBloodWoodPlant(int var1, int var2, int var3)
    {
        if (this.worldObj.isAirBlock(var1, var2 + 1, var3))
        {
            ...
            if (var4 == Block.slowSand.blockID || var4 == mod_FCBetterThanWolves.fcPlanter.blockID && ((FCBlockPlanter)((FCBlockPlanter)mod_FCBetterThanWolves.fcPlanter)).GetPlanterType(this.worldObj, var1, var2, var3) == 8)
            {
                this.worldObj.setBlockAndMetadataWithNotify(var1, var2 + 1, var3, mod_FCBetterThanWolves.fcAestheticVegetation.blockID, 2);
                --this.item.stackSize;
