    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (var6 > 0)
        {
            ...
            if (var12 != 0)
            {
                ...
                {
                    var11 = FCUtilsWorld.IsValidSourceForFluidBlockToFacing(par1World, par2, par3, par4, var10);
                    ...
                    if (var11 > 0 && (var12 < 0 || var11 < var12))
                    {
                        var12 = var11;
                    }
                }
            ...
            {
                var11 = this.getFlowDecay(par1World, par2, par3 + 1, par4);
