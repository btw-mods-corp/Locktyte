...
public class BlockVine extends Block
{
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
        ...
        if (!var12 && this.canBePlacedOn(par1IBlockAccess.getBlockId(par2, par3 + 1, par4)))
        {
    ...
    private boolean canBePlacedOn(int par1)
    {
        ...
        else
        {
            ...
            return var2.renderAsNormalBlock() && var2.blockMaterial.blocksMovement() || par1 == mod_FCBetterThanWolves.fcBlockDetector.blockID;
        }
    }
        ...
        if (!par1World.isRemote && par1World.rand.nextInt(4) == 0)
        {
            ...
            else
            {
                ...
                if (var10 >= 2 && var10 <= 5 && (var9 & 1 << var11) == 0)
                {
                    ...
                    if (var12 != 0 && Block.blocksList[var12] != null && !par1World.isAirBlock(par2 + Direction.offsetX[var11], par3, par4 + Direction.offsetZ[var11]))
                    {
                ...
                else if (par3 > 1)
                {
                    ...
                    if (var12 != 0 && !par1World.isAirBlock(par2, par3 - 1, par4))
                    {
