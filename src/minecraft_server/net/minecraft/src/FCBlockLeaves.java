...
public class FCBlockLeaves extends BlockLeaves implements FCIBlock
{
    public static final int m_iTextureIndex = 52;

    public FCBlockLeaves(int var1)
    {
        super(var1, 52);
        this.setBlockName("fcLeaves");
    ...
    {
        return mod_FCBetterThanWolves.fcAestheticVegetation.blockID;
    }
    ...
    public void harvestBlock(World var1, EntityPlayer var2, int var3, int var4, int var5, int var6)
    {
        ...
        {
            this.dropBlockAsItem_do(var1, var3, var4, var5, new ItemStack(mod_FCBetterThanWolves.fcLeaves.blockID, 1, var6 & 3));
    ...
    {
        if (var5.itemID == mod_FCBetterThanWolves.fcAestheticVegetation.blockID && var5.getItemDamage() == 2)
        {
            if (!var1.isRemote)
            {
                float var6 = 0.7F;
    ...
    {
        return this.blockIndexInTexture + (Block.leaves.graphicsLevel ? 0 : 1);
    }
                    ...
                    for (var12 = -var7; var12 <= var7; ++var12)
                    {
                        for (var13 = -var7; var13 <= var7; ++var13)
                        {
                            for (var14 = -var7; var14 <= var7; ++var14)
                            {
                                ...
                                if (var15 == mod_FCBetterThanWolves.fcBloodWood.blockID)
                                {
                                    this.adjacentTreeBlocks[(var12 + var11) * var10 + (var13 + var11) * var9 + var14 + var11] = 0;
                                }
                                else if (var15 == mod_FCBetterThanWolves.fcLeaves.blockID)
                                {
