...
public abstract class EntityPlayer extends EntityLiving implements ICommandSender
{
    ...
    protected int decreaseAirSupply(int par1)
    {
        ...
        return var2 > 0 && this.IsWearingSoulforgedHelm() ? (this.rand.nextInt(var2 * var2 + 1) > 0 ? par1 : par1 - 1) : (var2 > 0 && this.rand.nextInt(var2 + 1) > 0 ? par1 : super.decreaseAirSupply(par1));
    }
    ...
    public EntityItem dropPlayerItemWithRandomChoice(ItemStack par1ItemStack, boolean par2)
    {
        ...
        else
        {
            ...
            {
                var5 = 0.3F;
                var3.motionX = (double)(-MathHelper.sin(this.rotationYaw / 180.0F * (float)Math.PI) * MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI) * var5);
                var3.motionZ = (double)(MathHelper.cos(this.rotationYaw / 180.0F * (float)Math.PI) * MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI) * var5);
                var3.motionY = (double)(-MathHelper.sin(this.rotationPitch / 180.0F * (float)Math.PI) * var5 + 0.1F);
                var5 = 0.02F;
                var6 = this.rand.nextFloat() * (float)Math.PI * 2.0F;
                var5 *= this.rand.nextFloat();
                var3.motionX += Math.cos((double)var6) * (double)var5;
                var3.motionY += (double)((this.rand.nextFloat() - this.rand.nextFloat()) * 0.1F);
                var3.motionZ += Math.sin((double)var6) * (double)var5;
            }
    ...
    public void wakeUpPlayer(boolean par1, boolean par2, boolean par3)
    {
        ...
        if (var4 != null && this.worldObj.getBlockId(var4.posX, var4.posY, var4.posZ) == Block.bed.blockID)
        {
            ...
            ChunkCoordinates var6 = BlockBed.getNearestEmptyChunkCoordinates(this.worldObj, var4.posX, var4.posY, var4.posZ, 0);

            if (var6 == null)
            {
                var6 = new ChunkCoordinates(var4.posX, var4.posY + 1, var4.posZ);
            }

            this.setPosition((double)((float)var6.posX + 0.5F), (double)((float)var6.posY + this.yOffset + 0.1F), (double)((float)var6.posZ + 0.5F));
        }
        ...
        if (this.ridingEntity == null)
        {
            ...
            else if (this.onGround)
            {
                ...
                if (var7 > 0)
                {
                    ...
                    if (this.isSprinting())
                    {
                        this.addExhaustion(0.09999999F * (float)var7 * 0.01F);
                    }
                    else
                    {
    ...
    public boolean isOnLadder()
    {
        ...
        return var5 instanceof FCIBlockClimbable ? ((FCIBlockClimbable)var5).IsBlockClimable(this.worldObj, var1, var2, var3) : super.isOnLadder();
    }

    public boolean isWeighted()
    {
        return this.IsWearingAnySoulforgedArmor();
    }

    public boolean IsWearingAnySoulforgedArmor()
    {
        for (int var1 = 0; var1 < this.inventory.armorInventory.length; ++var1)
        {
            if (this.inventory.armorInventory[var1] != null && this.inventory.armorInventory[var1].getItem() instanceof FCItemRefinedArmor)
            {
                return true;
            }
        }
    ...
    {
        return this.inventory.armorInventory[3] != null && this.inventory.armorInventory[3].getItem().shiftedIndex == mod_FCBetterThanWolves.fcPlateHelm.shiftedIndex;
    }

    protected boolean IsWearingSoulforgedBoots()
    {
        return this.inventory.armorInventory[0] != null && this.inventory.armorInventory[0].getItem().shiftedIndex == mod_FCBetterThanWolves.fcPlateBoots.shiftedIndex;
    }
    ...
    protected void playStepSound(int var1, int var2, int var3, int var4)
    {
        if (this.IsWearingSoulforgedBoots())
        {
            ...
            if (this.worldObj.getBlockId(var1, var2 + 1, var3) == Block.snow.blockID)
            {
                ...
                this.worldObj.playSoundAtEntity(this, var5.getStepSound(), var5.getVolume() * 0.3F, var5.getPitch() * 0.75F);
            }
            else if (!Block.blocksList[var4].blockMaterial.isLiquid())
            {
                this.worldObj.playSoundAtEntity(this, var5.getStepSound(), var5.getVolume() * 0.3F, var5.getPitch() * 0.5F);
            }
        }
        else
        {
