...
public class EntityPlayerMP extends EntityPlayer implements ICrafting
{
    ...
    public void onUpdate()
    {
        ...
        for (var1 = 0; var1 < 5; ++var1)
        {
            ...
            {
                this.getServerForPlayer().getEntityTracker().sendPacketToTrackedPlayers(this, new Packet5PlayerInventory(this.entityId, var1, var2));
    ...
    public void onUpdateEntity()
    {
        ...
        for (int var1 = 0; var1 < this.inventory.getSizeInventory(); ++var1)
        {
            ...
            if (var2 != null && Item.itemsList[var2.itemID].isMap() && this.playerNetServerHandler.getNumChunkDataPackets() <= 2)
            {
    ...
    public void swingItem()
    {
        if (!this.isSwinging)
        {
            ...
            this.getServerForPlayer().getEntityTracker().sendPacketToTrackedPlayers(this, new Packet18Animation(this, 1));
        }
    }
