...
public class BlockCrops extends BlockFlower
{
    ...
    {
        if (FCUtilsMisc.DoesBlockMaximizeGrowthRate(par1World, par2, par3 - 1, par4, this))
        {
            return 10.0F * FCUtilsMisc.GetBlockGrowthMultiplier(par1World, par2, par3 - 1, par4, this);
        }
        else
        {
            float var5 = 1.0F;
            ...
            for (int var17 = par2 - 1; var17 <= par2 + 1; ++var17)
            {
                for (int var18 = par4 - 1; var18 <= par4 + 1; ++var18)
                {
                    ...
                    else if (FCUtilsMisc.CanPlantGrowOnBlock(par1World, var17, par3 - 1, var18, this))
                    {
                        ...
                        if (var21 instanceof FCISoil)
                        {
                            FCISoil var22 = (FCISoil)var21;

                            if (var22.IsBlockHydrated(par1World, var17, par3 - 1, var18))
                            {
                                var20 = 3.0F;
                            }
                        }
