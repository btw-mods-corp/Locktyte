...
public class EntitySkeleton extends EntityMob
{
    ...
    {
        return mod_FCBetterThanWolves.fcItemRottenArrow.shiftedIndex;
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(mod_FCBetterThanWolves.fcItemRottenArrow.shiftedIndex, 1);
        }
    ...
    public void CheckForScrollDrop()
    {
        ...
        {
            ItemStack var1 = new ItemStack(mod_FCBetterThanWolves.fcArcaneScroll, 1, Enchantment.projectileProtection.effectId);
