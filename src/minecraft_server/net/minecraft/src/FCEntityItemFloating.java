...
public class FCEntityItemFloating extends EntityItem implements FCIEntityPacketHandler
{
    ...
    public void onUpdate()
    {
        ...
        {
            var14 = 0.5880001F;
            int var13 = this.worldObj.getBlockId(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY) - 1, MathHelper.floor_double(this.posZ));

            if (var13 > 0)
            {
                var14 = Block.blocksList[var13].slipperiness * 0.98F;
            }
        }
