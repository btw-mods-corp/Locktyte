...
public class FCEntityMovingPlatform extends Entity implements FCIEntityPacketHandler, FCIEntityIgnoreServerValidation
{
    ...
    public void onUpdate()
    {
        if (!this.isDead)
        {
            ...
            if (!this.worldObj.isRemote)
            {
                List var6 = this.worldObj.getEntitiesWithinAABB(FCEntityMovingAnchor.class, AxisAlignedBB.getAABBPool().addOrModifyAABBInPool(this.m_AssociatedAnchorLastKnownXPos - 0.25D, this.m_AssociatedAnchorLastKnownYPos - 0.25D, this.m_AssociatedAnchorLastKnownZPos - 0.25D, this.m_AssociatedAnchorLastKnownXPos + 0.25D, this.m_AssociatedAnchorLastKnownYPos + 0.25D, this.m_AssociatedAnchorLastKnownZPos + 0.25D));
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (!var2)
                {
                    ...
                    if (this.motionY > 0.0D)
                    {
                        ...
                        {
                            if (Block.blocksList[var15].blockMaterial.isSolid())
                            {
                            ...
                            Block.blocksList[var15].dropBlockAsItem(this.worldObj, var3, var11, var5, this.worldObj.getBlockMetadata(var3, var11, var5), 0);
    ...
    public void DestroyPlatformWithDrop()
    {
        ...
        ItemStack var4 = new ItemStack(mod_FCBetterThanWolves.fcPlatform);
    ...
    private void ConvertToBlock(int var1, int var2, int var3, FCEntityMovingAnchor var4, boolean var5)
    {
        ...
        {
            this.worldObj.setBlockWithNotify(var1, var2, var3, mod_FCBetterThanWolves.fcPlatform.blockID);
        }
        else if (!Block.blocksList[var7].blockMaterial.isSolid())
        {
            Block.blocksList[var7].dropBlockAsItem(this.worldObj, var1, var2, var3, this.worldObj.getBlockMetadata(var1, var2, var3), 0);
            this.worldObj.setBlockWithNotify(var1, var2, var3, mod_FCBetterThanWolves.fcPlatform.blockID);
        }
        else
        {
            FCUtilsItem.EjectSingleItemWithRandomOffset(this.worldObj, var1, var2, var3, mod_FCBetterThanWolves.fcPlatform.blockID, 0);
            var6 = false;
        }
