...
public class FCEntityDynamite extends Entity implements FCIEntityPacketHandler
{
    ...
    public FCEntityDynamite(World var1, EntityLiving var2, int var3, boolean var4)
    {
        ...
        this.SetDynamiteHeading(this.motionX, this.motionY, this.motionZ, 0.75F, 1.0F);
    ...
    public void onUpdate()
    {
        if (!this.isDead)
        {
            ...
            else if (var4 != Block.fire.blockID && var4 != mod_FCBetterThanWolves.fcStokedFire.blockID)
            {
    ...
    public void SetDynamiteHeading(double var1, double var3, double var5, float var7, float var8)
    {
    ...
    {
        ItemStack var4 = new ItemStack(Item.fishRaw.shiftedIndex, 1, 0);
        Object var5;
    ...
    {
        FCUtilsItem.EjectSingleItemWithRandomVelocity(this.worldObj, (float)this.posX, (float)this.posY, (float)this.posZ, mod_FCBetterThanWolves.fcDynamite.shiftedIndex, 0);
        this.setDead();
    }
}
