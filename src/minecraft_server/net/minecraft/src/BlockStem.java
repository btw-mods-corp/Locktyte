        ...
        if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
        {
            ...
            if (par5Random.nextInt((int)(25.0F / var6) + 1) == 0)
            {
                ...
                if (var7 < 7)
                {
                    ...
                    if (var7 == 7)
                    {
                        FCUtilsMisc.NotifySoilOfPlantGrowth(par1World, par2, par3 - 1, par4, this);
                    }
                }
                else
                {
                    ...
                    if (par1World.isAirBlock(var9, par3, var10) && (var11 == Block.tilledField.blockID || var11 == Block.dirt.blockID || var11 == Block.grass.blockID || FCUtilsMisc.CanPlantGrowOnBlock(par1World, var9, par3 - 1, var10, this.fruitType)))
                    {
    ...
    private float getGrowthModifier(World par1World, int par2, int par3, int par4)
    {
        ...
        for (int var17 = par2 - 1; var17 <= par2 + 1; ++var17)
        {
            for (int var18 = par4 - 1; var18 <= par4 + 1; ++var18)
            {
                ...
                else if (FCUtilsMisc.CanPlantGrowOnBlock(par1World, var17, par3 - 1, var18, this))
                {
                    var20 = 1.0F;
                    Block var21 = Block.blocksList[var19];

                    if (var21 instanceof FCISoil && ((FCISoil)var21).IsBlockHydrated(par1World, var17, par3 - 1, var18))
                    {
                        var20 = 3.0F;
                    }
                }
        ...
        var5 *= FCUtilsMisc.GetBlockGrowthMultiplier(par1World, par2, par3 - 1, par4, this);
        return var5;
    }
