...
public class FCBlockPlatform extends Block implements FCIBlock, ITextureProvider, FCIBlockSolidTop
{
            ...
            for (int var7 = var3 - 2; var7 <= var3 + 2; ++var7)
            {
                for (int var8 = var4 - 2; var8 <= var4 + 2; ++var8)
                {
                    ...
                    if (var9 == this.blockID)
                    {
                        ...
                        if (var10 == mod_FCBetterThanWolves.fcAnchor.blockID && ((FCBlockAnchor)((FCBlockAnchor)mod_FCBetterThanWolves.fcAnchor)).GetFacing(var1, var6, var7 + 1, var8) == 1 && this.IsPlatformConnectedToAnchorPoint(var1, var2, var3, var4, var6, var7, var8))
                        {
