...
public class VillageSiege
{
    ...
    public void tick()
    {
        ...
        else
        {
            ...
            if (this.field_75536_c == 0)
            {
                ...
                this.field_75536_c = this.worldObj.rand.nextInt(10) != 0 ? 2 : 1;
    ...
    private Vec3 func_75527_a(int par1, int par2, int par3)
    {
        for (int var4 = 0; var4 < 10; ++var4)
        {
            ...
            if (this.theVillage.isInRange(var5, var6, var7) && SpawnerAnimals.canCreatureTypeSpawnAtLocation(EnumCreatureType.monster, this.worldObj, var5, var6, var7) && FCUtilsWorld.CanMobsSpawnHere(this.worldObj, var5, var6, var7))
            {
