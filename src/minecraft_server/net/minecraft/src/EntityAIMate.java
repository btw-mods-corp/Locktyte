...
public class EntityAIMate extends EntityAIBase
{
    ...
    private void spawnBaby()
    {
        ...
        if (var1 != null)
        {
            ...
            if (this.theAnimal.getWearingBreedingHarness())
            {
                var1.setLocationAndAngles((this.targetMate.posX + this.theAnimal.posX) / 2.0D, (this.targetMate.posY + this.theAnimal.posY) / 2.0D, (this.targetMate.posZ + this.theAnimal.posZ) / 2.0D, this.theAnimal.rotationYaw, this.theAnimal.rotationPitch);
            }
            else
            {
                var1.setLocationAndAngles(this.theAnimal.posX, this.theAnimal.posY, this.theAnimal.posZ, this.theAnimal.rotationYaw, this.theAnimal.rotationPitch);
            }
            ...
            for (int var3 = 0; var3 < 7; ++var3)
            {
                ...
                this.theWorld.playSoundAtEntity(this.theAnimal, this.theAnimal.getDeathSound(), this.theAnimal.getSoundVolume(), (var2.nextFloat() - var2.nextFloat()) * 0.2F + 1.0F);
                this.theWorld.playAuxSFX(2222, MathHelper.floor_double(var1.posX), MathHelper.floor_double(var1.posY), MathHelper.floor_double(var1.posZ), 0);
            }
        }
    }
}
