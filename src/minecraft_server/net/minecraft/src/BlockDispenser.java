...
public class BlockDispenser extends BlockContainer
{
    ...
    private static int spawnEntityWithAction(TileEntityDispenser par0TileEntityDispenser, World par1World, ItemStack par2ItemStack, Random par3Random, int par4, int par5, int par6, int par7, int par8, double par9, double par11, double par13)
    {
        ...
        else if ((par2ItemStack.itemID == Item.bucketLava.shiftedIndex || par2ItemStack.itemID == Item.bucketWater.shiftedIndex) && !mod_FCBetterThanWolves.IsHardcoreBucketsEnabled(par1World))
        {
        ...
        else if (par2ItemStack.itemID == Item.bucketEmpty.shiftedIndex && !mod_FCBetterThanWolves.IsHardcoreBucketsEnabled(par1World))
        {
            int var22 = par4 + par7;
            int var18 = par6 + par8;
            Material var19 = par1World.getBlockMaterial(var22, par5, var18);
            int var20 = par1World.getBlockMetadata(var22, par5, var18);

            if (var19 == Material.water && var20 == 0)
            {
                par1World.setBlockWithNotify(var22, par5, var18, 0);
        ...
        else if (par2ItemStack.getItem() instanceof ItemMinecart)
        {
            ...
            EntityMinecart var23 = new EntityMinecart(par1World, par9, par11, par13, ((ItemMinecart)par2ItemStack.getItem()).minecartType);
        ...
        else if (par2ItemStack.itemID == Item.boat.shiftedIndex)
        {
            ...
            EntityBoat var17 = new EntityBoat(par1World, par9, par11, par13);
        ...
        {
            return mod_FCBetterThanWolves.m_instance.dispenseEntity(par1World, par2ItemStack, par3Random, par4, par5, par6, par7, par8, par9, par11, par13);
        }
    }
}
