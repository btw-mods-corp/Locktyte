...
public class FCBlockSoulforgedSteel extends Block implements FCIBlock, ITextureProvider
{
    ...
    protected FCBlockSoulforgedSteel(int var1)
    {
        ...
        this.setBlockName("fcSoulforgedSteelBlock");
    ...
    {
        if (this.IsRedstonePowerFlagOn(var1, var2, var3, var4) != this.IsReceivingRedstonePower(var1, var2, var3, var4))
        {
            var1.scheduleBlockUpdate(var2, var3, var4, this.blockID, this.tickRate());
        }
        else if (this.IsActivatedByWaterFlagOn(var1, var2, var3, var4) != this.IsBlockNeighboringOnWater(var1, var2, var3, var4))
        {
            var1.scheduleBlockUpdate(var2, var3, var4, this.blockID, this.tickRate());
        }
    }
