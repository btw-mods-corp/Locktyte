...
public class WorldInfo
{
    ...
    private InventoryEnderChest hardcoreEnderChestInventory;

    protected WorldInfo()
    {
        this.terrainType = WorldType.DEFAULT;
        this.hardcoreEnderChestInventory = new InventoryEnderChest();
    }
    ...
    public WorldInfo(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            NBTTagList var4 = par1NBTTagCompound.getTagList("FCEnderItems");
            this.hardcoreEnderChestInventory.loadInventoryFromNBT(var4);
        }
    }
    ...
    public WorldInfo(WorldInfo par1WorldInfo)
    {
        ...
        this.hardcoreEnderChestInventory = par1WorldInfo.hardcoreEnderChestInventory;

        if (this.hardcoreEnderChestInventory == null)
        {
            this.hardcoreEnderChestInventory = new InventoryEnderChest();
        }
    }
    ...
    private void updateTagCompound(NBTTagCompound par1NBTTagCompound, NBTTagCompound par2NBTTagCompound)
    {
        ...
        if (this.hardcoreEnderChestInventory != null)
        {
            par1NBTTagCompound.setTag("FCEnderItems", this.hardcoreEnderChestInventory.saveInventoryToNBT());
        }
    ...
    public InventoryEnderChest GetHardcoreEnderChestInventory()
    {
        return this.hardcoreEnderChestInventory;
    }
}
