    ...
    public void onEntityCollidedWithBlock(World var1, int var2, int var3, int var4, Entity var5)
    {
        if (!var1.isRemote && !var5.isDead)
        {
            if (var5 instanceof EntityItem)
            {
                ...
                ItemStack var7 = var6.item;

                if (var7.getItem().shiftedIndex == Item.dyePowder.shiftedIndex && var7.getItemDamage() == 15)
                {
                    --var7.stackSize;
                    ...
                    var1.setBlockAndMetadataWithNotify(var2, var3, var4, mod_FCBetterThanWolves.fcBlockFarmlandFertilized.blockID, var8);
