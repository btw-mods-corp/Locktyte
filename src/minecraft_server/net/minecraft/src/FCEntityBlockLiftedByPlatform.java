...
public class FCEntityBlockLiftedByPlatform extends Entity implements FCIEntityPacketHandler, FCIEntityIgnoreServerValidation
{
    ...
    public FCEntityBlockLiftedByPlatform(World var1, int var2, int var3, int var4)
    {
        ...
        if (var5 != Block.railPowered.blockID && var5 != Block.railDetector.blockID && var5 != mod_FCBetterThanWolves.fcDetectorRailWood.blockID && var5 != mod_FCBetterThanWolves.fcDetectorRailObsidian.blockID)
        {
    ...
    public void onUpdate()
    {
        if (!this.isDead)
        {
            ...
            List var2 = this.worldObj.getEntitiesWithinAABB(FCEntityMovingPlatform.class, AxisAlignedBB.getAABBPool().addOrModifyAABBInPool(this.posX - 0.25D, this.posY - 1.25D, this.posZ - 0.25D, this.posX + 0.25D, this.posY - 0.75D, this.posZ + 0.25D));
    ...
    private void ConvertToBlock(int var1, int var2, int var3)
    {
        ...
        if (this.worldObj.getBlockId(var1, var2 - 1, var3) == mod_FCBetterThanWolves.fcPlatform.blockID && FCUtilsWorld.IsReplaceableBlock(this.worldObj, var1, var2, var3))
        {
