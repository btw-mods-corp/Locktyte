...
public class BlockNote extends BlockContainer
{
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        else
        {
            ...
            if (var10 != null)
            {
                ItemStack var11 = par5EntityPlayer.getCurrentEquippedItem();

                if (var11 != null && var11.getItem().shiftedIndex == mod_FCBetterThanWolves.fcTuningFork.shiftedIndex)
                {
                    var10.note = (byte)var11.getItemDamage();
