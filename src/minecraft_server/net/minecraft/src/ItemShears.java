...
public class ItemShears extends Item
{
    ...
    {
        return par2Block.blockID == mod_FCBetterThanWolves.fcLeaves.blockID ? 15.0F : (par2Block.blockID != Block.web.blockID && par2Block.blockID != Block.leaves.blockID ? (par2Block.blockID == Block.cloth.blockID ? 5.0F : super.getStrVsBlock(par1ItemStack, par2Block)) : 15.0F);
    }
}
