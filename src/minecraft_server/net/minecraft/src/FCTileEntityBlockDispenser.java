...
public class FCTileEntityBlockDispenser extends TileEntity implements IInventory
{
    ...
    public ItemStack GetNextStackFromInventory()
    {
        ...
        {
            var2 = this.FindNextValidSlotIndex(this.iNextSlotIndexToDispense);
            ...
            this.iNextSlotIndexToDispense = var2;
        }

        var1 = this.decrStackSize(this.iNextSlotIndexToDispense, 1);
        var2 = this.FindNextValidSlotIndex(this.iNextSlotIndexToDispense);
