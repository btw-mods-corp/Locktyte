...
public class FCBlockDetectorLogic extends Block implements FCIBlock
{
    ...
    {
        if (!mod_FCBetterThanWolves.bIsLensBeamBeingRemoved && (!this.IsDetectorLogicFlagOn(var1, var2, var3, var4) || this.IsIntersectionPointFlagOn(var1, var2, var3, var4)))
        {
            for (int var7 = 0; var7 <= 5; ++var7)
            {
                ...
                if (var8 > 0)
                {
                    ...
                    if (var9 > 0)
                    {
                        this.RemoveLensBeamFromBlock(var1, var2, var3, var4, FCUtilsMisc.GetOppositeFacing(var7), var9);
                    }
                }
            }
        }
    ...
    public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5)
    {
        ...
        if (var5 == 0)
        {
            if (!this.IsDetectorLogicFlagOn(var1, var2, var3, var4) || this.IsIntersectionPointFlagOn(var1, var2, var3, var4))
            {
                var1.scheduleBlockUpdate(var2, var3, var4, var1.getBlockId(var2, var3, var4), this.tickRate());
            }
        }
        else if (this.IsLitFlagOn(var1, var2, var3, var4) && !this.IsBlockGlowing(var1, var2, var3, var4))
        {
            var1.scheduleBlockUpdate(var2, var3, var4, var1.getBlockId(var2, var3, var4), this.tickRate());
        }
    ...
    public boolean IsBlockGlowing(World var1, int var2, int var3, int var4)
    {
        ...
        return var5 == mod_FCBetterThanWolves.fcBlockDetectorGlowingLogic.blockID;
    }
    ...
    public void SetBlockAsGlowing(World var1, int var2, int var3, int var4)
    {
        ...
        var1.setBlockAndMetadataWithNotify(var2, var3, var4, mod_FCBetterThanWolves.fcBlockDetectorGlowingLogic.blockID, var5);
    ...
    public void SetBlockAsNotGlowing(World var1, int var2, int var3, int var4)
    {
        int var5 = var1.getBlockMetadata(var2, var3, var4);
        mod_FCBetterThanWolves.bIsLensBeamBeingRemoved = true;
        var1.setBlockAndMetadataWithNotify(var2, var3, var4, mod_FCBetterThanWolves.fcBlockDetectorLogic.blockID, var5);
        mod_FCBetterThanWolves.bIsLensBeamBeingRemoved = false;
    ...
    {
        List var5 = var1.getEntitiesWithinAABB(Entity.class, AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double)var2, (double)var3, (double)var4, (double)(var2 + 1), (double)(var3 + 1), (double)(var4 + 1)));
    ...
    private boolean CheckForNeighboringDetector(World var1, int var2, int var3, int var4)
    {
        for (int var5 = 0; var5 <= 5; ++var5)
        {
            ...
            if (var1.getBlockId(var6.i, var6.j, var6.k) == mod_FCBetterThanWolves.fcBlockDetector.blockID && ((FCBlockDetectorBlock)((FCBlockDetectorBlock)mod_FCBetterThanWolves.fcBlockDetector)).GetFacing(var1, var6.i, var6.j, var6.k) == FCUtilsMisc.GetOppositeFacing(var5))
            {
                return true;
            }
        }
    ...
    public int GetRangeToValidLensSourceToFacing(World var1, int var2, int var3, int var4, int var5)
    {
        ...
        for (int var7 = 1; var7 <= 128; ++var7)
        {
            ...
            if (var8 == mod_FCBetterThanWolves.fcLens.blockID)
            {
    ...
    public int GetRangeToValidLitLensSourceToFacing(IBlockAccess var1, int var2, int var3, int var4, int var5)
    {
        ...
        for (int var7 = 1; var7 <= 128; ++var7)
        {
            ...
            if (var8 == mod_FCBetterThanWolves.fcLens.blockID)
            {
                ...
                if (var9.GetFacing(var1, var6.i, var6.j, var6.k) == FCUtilsMisc.GetOppositeFacing(var5) && var9.IsLit(var1, var6.i, var6.j, var6.k))
                {
                    return var7;
                }
    ...
    public void CreateLensBeamFromBlock(World var1, int var2, int var3, int var4, int var5, int var6)
    {
        ...
        for (int var8 = 1; var8 <= var6; ++var8)
        {
            ...
            if (var9 == 0)
            {
                if (!var1.setBlock(var7.i, var7.j, var7.k, mod_FCBetterThanWolves.fcBlockDetectorLogic.blockID))
                {
                    break;
                }
            }
    ...
    public void RemoveLensBeamFromBlock(World var1, int var2, int var3, int var4, int var5, int var6)
    {
        mod_FCBetterThanWolves.bIsLensBeamBeingRemoved = true;
        FCUtilsBlockPos var7 = new FCUtilsBlockPos(var2, var3, var4);
        int var8 = FCUtilsMisc.GetOppositeFacing(var5);
        ...
        for (int var9 = 1; var9 <= 128; ++var9)
        {
            ...
            {
                if (!var1.setBlock(var7.i, var7.j, var7.k, 0))
                {
                    break;
                }
            }
        ...
        if (this.IsLitFlagOn(var1, var2, var3, var4))
        {
            ...
            for (int var5 = 0; var5 <= 5; ++var5)
            {
                ...
                if (var6 > 0)
                {
                    ...
                    if (var7 > 0)
                    {
                        this.TurnBeamOffFromBlock(var1, var2, var3, var4, FCUtilsMisc.GetOppositeFacing(var5), var7);
                    }
                }
            }
        }
    ...
    public void ChangeStateToClearEntityCollision(World var1, int var2, int var3, int var4)
    {
        ...
        for (int var5 = 0; var5 <= 5; ++var5)
        {
            ...
            if (var6 > 0)
            {
                ...
                if (var7 > 0)
                {
                    this.TurnBeamOnFromBlock(var1, var2, var3, var4, FCUtilsMisc.GetOppositeFacing(var5), var7);
                }
            }
        }
        ...
        for (int var8 = 1; var8 <= var6; ++var8)
        {
            ...
            if (!IsLogicBlock(var9))
            {
                if (!var1.isAirBlock(var7.i, var7.j, var7.k))
                {
                    ...
                    var10.AddFacingAsOffset(FCUtilsMisc.GetOppositeFacing(var5));
    ...
    protected boolean ShouldBeProjectingToFacing(IBlockAccess var1, int var2, int var3, int var4, int var5)
    {
        ...
        else
        {
            FCUtilsBlockPos var6 = new FCUtilsBlockPos(var2, var3, var4);
            var6.AddFacingAsOffset(var5);
            return var1.isBlockNormalCube(var6.i, var6.j, var6.k) && this.HasValidLitLensSourceToFacing(var1, var2, var3, var4, FCUtilsMisc.GetOppositeFacing(var5));
        }
    }
    ...
    protected boolean ShouldBeGlowingToFacing(World var1, int var2, int var3, int var4, int var5)
    {
        FCUtilsBlockPos var6 = new FCUtilsBlockPos(var2, var3, var4);
        var6.AddFacingAsOffset(var5);
        return !var1.isAirBlock(var6.i, var6.j, var6.k) && this.HasValidLitLensSourceToFacing(var1, var2, var3, var4, FCUtilsMisc.GetOppositeFacing(var5));
    }
    ...
    {
        return var0 == mod_FCBetterThanWolves.fcBlockDetectorLogic.blockID || var0 == mod_FCBetterThanWolves.fcBlockDetectorGlowingLogic.blockID;
    }
    ...
    void PropagateBeamsThroughBlock(World var1, int var2, int var3, int var4)
    {
        ...
        if (var1.setBlock(var2, var3, var4, mod_FCBetterThanWolves.fcBlockDetectorLogic.blockID))
        {
            for (int var7 = 0; var7 <= 5; ++var7)
            {
                int var8 = this.GetRangeToValidLensSourceToFacing(var1, var2, var3, var4, var7);
                ...
                if (var8 > 0)
                {
                    ...
                    if (var9 > 0)
                    {
                        int var10 = FCUtilsMisc.GetOppositeFacing(var7);
        ...
        for (int var8 = 0; var8 <= 5; ++var8)
        {
            ...
            if (var9 > 0)
            {
                ...
                if (var10 > 0)
                {
                    ...
                    var11.AddFacingAsOffset(FCUtilsMisc.GetOppositeFacing(var8));
