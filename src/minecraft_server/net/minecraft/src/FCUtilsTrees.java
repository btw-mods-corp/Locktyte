    ...
    public static boolean GenerateTaiga2(World var0, Random var1, int var2, int var3, int var4)
    {
        ...
        if (var3 >= 1)
        {
            ...
            if (var3 + var5 + 1 <= 128)
            {
                        ...
                        for (var13 = var4 - var19; var13 <= var4 + var19 && var9; ++var13)
                        {
                            if (var10 >= 0)
                            {
                                ...
                                if (var10 < 128)
                                {
                                    ...
                                    if (!var0.isAirBlock(var12, var10, var13) && var14 != Block.leaves.blockID)
                                    {
                                        var9 = false;
                                    }
                ...
                var10 = var0.getBlockId(var2, var3 - 1, var4);

                if (var10 == Block.grass.blockID || var10 == Block.dirt.blockID || FCUtilsMisc.CanPlantGrowOnBlock(var0, var2, var3 - 1, var4, Block.sapling))
                {
                    var0.getClass();
    ...
    public static boolean GenerateForest(World var0, Random var1, int var2, int var3, int var4)
    {
        ...
        if (var3 >= 1)
        {
            ...
            if (var3 + var5 + 1 <= 128)
            {
                ...
                var7 = var0.getBlockId(var2, var3 - 1, var4);

                if (var7 == Block.grass.blockID || var7 == Block.dirt.blockID || FCUtilsMisc.CanPlantGrowOnBlock(var0, var2, var3 - 1, var4, Block.sapling))
                {
                    var0.getClass();
    ...
    public static boolean GenerateTrees(World var0, Random var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8)
    {
        ...
        if (var3 >= 1 && var3 + var9 + 1 <= 256)
        {
            ...
            else
            {
                ...
                if ((var11 == Block.grass.blockID || var11 == Block.dirt.blockID || FCUtilsMisc.CanPlantGrowOnBlock(var0, var2, var3 - 1, var4, Block.sapling)) && var3 < 256 - var9 - 1)
                {
