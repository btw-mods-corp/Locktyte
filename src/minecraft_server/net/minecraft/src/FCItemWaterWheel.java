...
public class FCItemWaterWheel extends Item implements ITextureProvider
{
    public FCItemWaterWheel(int var1)
    {
        super(var1);
        this.setIconIndex(12);
        this.setItemName("fcWaterWheelItem");
        this.maxStackSize = 1;
    }
    ...
    public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7, float var8, float var9, float var10)
    {
        ...
        if (var11 == mod_FCBetterThanWolves.fcAxleBlock.blockID)
        {
            ...
            if (var12 != 0)
            {
                ...
                if (FCEntityWaterWheel.WaterWheelValidateAreaAroundBlock(var3, var4, var5, var6, var13))
                {
                    if (!var3.isRemote)
                    {
