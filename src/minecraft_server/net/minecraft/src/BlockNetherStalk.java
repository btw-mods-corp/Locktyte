...
public class BlockNetherStalk extends BlockFlower
{
    ...
    {
        return this.canThisPlantGrowOnThisBlockID(par1World.getBlockId(par2, par3 - 1, par4)) || FCUtilsMisc.CanPlantGrowOnBlock(par1World, par2, par3 - 1, par4, this);
    }
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
            BiomeGenBase var7 = par1World.getBiomeGenForCoords(par2, par4);
