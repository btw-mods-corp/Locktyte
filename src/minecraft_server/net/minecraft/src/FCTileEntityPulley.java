...
public class FCTileEntityPulley extends TileEntity implements IInventory
{
    ...
    public void updateEntity()
    {
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.iUpdateRopeStateCounter <= 0)
            {
                ...
                {
                    boolean var1 = ((FCBlockPulley)mod_FCBetterThanWolves.fcPulley).IsRedstoneOn(this.worldObj, this.xCoord, this.yCoord, this.zCoord);

                    if (!var1)
                    {
                        boolean var2 = ((FCBlockPulley)mod_FCBetterThanWolves.fcPulley).IsBlockOn(this.worldObj, this.xCoord, this.yCoord, this.zCoord);
    ...
    {
        return ((FCBlockPulley)mod_FCBetterThanWolves.fcPulley).IsBlockOn(this.worldObj, this.xCoord, this.yCoord, this.zCoord);
    }

    private boolean IsRedstonePowered()
    {
        return ((FCBlockPulley)mod_FCBetterThanWolves.fcPulley).IsRedstoneOn(this.worldObj, this.xCoord, this.yCoord, this.zCoord);
    }
    ...
    {
        return !this.IsRedstonePowered() && !this.IsMechanicallyPowered() && FCUtilsInventory.GetFirstOccupiedStackOfItem(this, mod_FCBetterThanWolves.fcRopeItem.shiftedIndex) >= 0;
    }
    ...
    private void NotifyAttachedAnchorOfEntityStateChange()
    {
        for (int var1 = this.yCoord - 1; var1 >= 0; --var1)
        {
            ...
            if (var2 == mod_FCBetterThanWolves.fcAnchor.blockID)
            {
                if (((FCBlockAnchor)((FCBlockAnchor)mod_FCBetterThanWolves.fcAnchor)).GetFacing(this.worldObj, this.xCoord, var1, this.zCoord) != 1)
                {
                    break;
                }

                if (((FCBlockAnchor)((FCBlockAnchor)mod_FCBetterThanWolves.fcAnchor)).NotifyAnchorBlockOfAttachedPulleyStateChange(this, this.worldObj, this.xCoord, var1, this.zCoord))
                {
                    this.m_bHasAssociatedAnchorEntity = true;
                }
            }
            else if (var2 != mod_FCBetterThanWolves.fcRopeBlock.blockID)
            {
                break;
            }
        }
    ...
    boolean AttemptToRetractRope()
    {
        for (int var1 = this.yCoord - 1; var1 >= 0; --var1)
        {
            ...
            if (var2 != mod_FCBetterThanWolves.fcRopeBlock.blockID)
            {
                return false;
            }

            if (this.worldObj.getBlockId(this.xCoord, var1 - 1, this.zCoord) != mod_FCBetterThanWolves.fcRopeBlock.blockID)
            {
                this.AddRopeToInventory();
                Block var3 = mod_FCBetterThanWolves.fcRopeBlock;
    ...
    {
        int var1 = FCUtilsInventory.GetFirstOccupiedStackOfItem(this, mod_FCBetterThanWolves.fcRopeItem.shiftedIndex);
        this.iUpdateRopeStateCounter = 20;
        ...
        if (var1 >= 0)
        {
            for (int var2 = this.yCoord - 1; var2 >= 0; --var2)
            {
                ...
                {
                    if (this.worldObj.setBlockWithNotify(this.xCoord, var2, this.zCoord, mod_FCBetterThanWolves.fcRopeBlock.blockID))
                    {
                        mod_FCBetterThanWolves.fcRopeBlock.updateBlockMetadata(this.worldObj, this.xCoord, var2, this.zCoord, 0, 0.0F, 0.0F, 0.0F);
                        Block var4 = mod_FCBetterThanWolves.fcRopeBlock;
                        this.worldObj.playSoundEffect((double)((float)this.xCoord + 0.5F), (double)((float)var2 + 0.5F), (double)((float)this.zCoord + 0.5F), var4.stepSound.getStepSound(), var4.stepSound.getVolume() / 4.0F, var4.stepSound.getPitch() * 0.8F);
                        this.RemoveRopeFromInventory();
                        int var5 = this.worldObj.getBlockId(this.xCoord, var2 - 1, this.zCoord);

                        if (var5 == mod_FCBetterThanWolves.fcAnchor.blockID && ((FCBlockAnchor)((FCBlockAnchor)mod_FCBetterThanWolves.fcAnchor)).GetFacing(this.worldObj, this.xCoord, var2 - 1, this.zCoord) == 1)
                        {
                            ((FCBlockAnchor)((FCBlockAnchor)mod_FCBetterThanWolves.fcAnchor)).NotifyAnchorBlockOfAttachedPulleyStateChange(this, this.worldObj, this.xCoord, var2 - 1, this.zCoord);
                        }
                ...
                if (var3 != mod_FCBetterThanWolves.fcRopeBlock.blockID)
                {
                    return false;
                }
            }
    ...
    {
        ItemStack var1 = new ItemStack(mod_FCBetterThanWolves.fcRopeItem);
        this.iUpdateRopeStateCounter = 20;
    ...
    {
        return FCUtilsInventory.CountItemsInInventory(this, mod_FCBetterThanWolves.fcRopeItem.shiftedIndex, -1);
    }
