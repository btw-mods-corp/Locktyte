...
public class BlockCake extends Block
{
    ...
    {
        int var5 = this.GetEatState(par1IBlockAccess, par2, par3, par4);
        float var6 = 0.0625F;
    ...
    {
        int var5 = this.GetEatState(par1World, par2, par3, par4);
        float var6 = 0.0625F;
        float var7 = (float)(1 + var5 * 2) / 16.0F;
        float var8 = 0.5F;
    ...
    private void eatCakeSlice(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer)
    {
        if (par5EntityPlayer.canEat(false))
        {
            ...
            int var6 = this.GetEatState(par1World, par2, par3, par4) + 1;
            ...
            {
                this.SetEatState(par1World, par2, par3, par4, var6);
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        {
            boolean var6 = this.IsRedstoneOn(par1World, par2, par3, par4);
            boolean var7 = par1World.isBlockGettingPowered(par2, par3, par4);

            if (var6 != var7)
            {
                this.SetRedstoneOn(par1World, par2, par3, par4, var7);

                if (var7)
                {
                    par1World.playAuxSFX(2225, par2, par3, par4, 0);
                }
            }
        }
    }
