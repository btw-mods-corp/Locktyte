        ...
        if (!par1World.isRemote)
        {
            ...
            else if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
            {
                for (int var6 = 0; var6 < 4; ++var6)
                {
                    ...
                    {
                        int var11 = par1World.getBlockId(var7, var8 + 1, var9);

                        if (var11 != mod_FCBetterThanWolves.fcBlockDirtSlab.blockID || ((FCBlockDirtSlab)((FCBlockDirtSlab)mod_FCBetterThanWolves.fcBlockDirtSlab)).GetIsUpsideDown(par1World, var7, var8 + 1, var9))
                        {
