...
public class Packet26EntityExpOrb extends Packet
{
    ...
    public Packet26EntityExpOrb(EntityXPOrb par1EntityXPOrb)
    {
        ...
        this.m_bNotPlayerOwned = par1EntityXPOrb.m_bNotPlayerOwned;
    }
    ...
    public void readPacketData(DataInputStream par1DataInputStream) throws IOException
    {
        ...
        this.m_bNotPlayerOwned = par1DataInputStream.readBoolean();
    }
    ...
    public void writePacketData(DataOutputStream par1DataOutputStream) throws IOException
    {
        ...
        par1DataOutputStream.writeBoolean(this.m_bNotPlayerOwned);
    }
