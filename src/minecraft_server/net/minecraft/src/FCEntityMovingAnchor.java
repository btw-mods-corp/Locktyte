...
public class FCEntityMovingAnchor extends Entity implements FCIEntityPacketHandler, FCIEntityIgnoreServerValidation
{
    ...
    public FCEntityMovingAnchor(World var1, double var2, double var4, double var6, FCUtilsBlockPos var8, int var9)
    {
        ...
        if (var10 == mod_FCBetterThanWolves.fcPulley.blockID)
        {
    ...
    {
        return AxisAlignedBB.getBoundingBox(this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ, this.boundingBox.maxX, this.boundingBox.minY + (double)FCBlockAnchor.fAnchorBaseHeight, this.boundingBox.maxZ);
    }
        ...
        if (!this.isDead)
        {
            ...
            if (this.worldObj.checkChunksExist(var1 - var3, 0, var2 - var3, var1 + var3, 0, var2 + var3))
            {
                ...
                if (!this.worldObj.isRemote)
                {
                    ...
                    if (var7 == mod_FCBetterThanWolves.fcPulley.blockID)
                    {
                        if (var5 == mod_FCBetterThanWolves.fcPulley.blockID || var5 == mod_FCBetterThanWolves.fcRopeBlock.blockID || var8 == mod_FCBetterThanWolves.fcPulley.blockID || var8 == mod_FCBetterThanWolves.fcRopeBlock.blockID)
                        {
                ...
                int var15 = MathHelper.floor_double(var14 - (double)this.yOffset);
                ...
                if (!this.worldObj.isRemote && (this.m_iOldBottomJ != var15 || var6))
                {
                    if (this.motionY > 0.0D)
                    {
                        if (this.worldObj.getBlockId(var1, var15, var2) == mod_FCBetterThanWolves.fcRopeBlock.blockID)
                        {
                            var4.AttemptToRetractRope();
                        }

                        var11 = this.worldObj.getBlockId(var1, var15 + 1, var2);

                        if (var11 != mod_FCBetterThanWolves.fcRopeBlock.blockID || var4 == null || !var4.IsRaising() || var15 + 1 >= this.associatedPulleyPos.j)
                        {
                            this.ConvertToBlock(var1, var15, var2);
                            return;
                        }
                    }
                    else
                    {
                        ...
                        if (var4 != null)
                        {
                            ...
                            if (var5 == mod_FCBetterThanWolves.fcPulley.blockID || var5 == mod_FCBetterThanWolves.fcRopeBlock.blockID)
                            {
                                var16 = 1;
                                int var20 = this.worldObj.getBlockId(var1, this.m_iOldBottomJ, var2);

                                if (var20 == mod_FCBetterThanWolves.fcPulley.blockID || var20 == mod_FCBetterThanWolves.fcRopeBlock.blockID)
                                {
                                    var16 = 0;
                                }
                            }

                            if (var4.GetContainedRopeCount() >= var16)
                            {
                                var17 = true;
                            }
                            else
                        ...
                        int var19 = this.worldObj.getBlockId(var1, var15, var2);
                        boolean var18 = false;

                        if (var4 != null && var4.IsLowering() && var17)
                        {
                            if (!FCUtilsWorld.IsReplaceableBlock(this.worldObj, var1, var15, var2))
                            {
                                if (!Block.blocksList[var19].blockMaterial.isSolid())
                                {
                                    if (var19 == mod_FCBetterThanWolves.fcRopeBlock.blockID)
                                    {
                                        if (!this.ReturnRopeToPulley())
                                        {
                                            Block.blocksList[var19].dropBlockAsItem(this.worldObj, var1, var15, var2, this.worldObj.getBlockMetadata(var1, var15, var2), 0);
                                        }
                                    }
                                    else
                                    {
                                    ...
                                    this.worldObj.setBlockWithNotify(var1, var15, var2, 0);
                                }
                                else
                                {
                                    var18 = true;
                        ...
                        if (var4 != null && this.worldObj.getBlockId(var1, var15 + 1, var2) != mod_FCBetterThanWolves.fcRopeBlock.blockID && this.worldObj.getBlockId(var1, var15 + 1, var2) != mod_FCBetterThanWolves.fcPulley.blockID)
                        {
                            var4.AttemptToDispenseRope();
                        }
                    }

                    this.m_iOldBottomJ = var15;
                }
            }
        }
    }
    ...
    public void DestroyAnchorWithDrop()
    {
        ...
        ItemStack var4 = new ItemStack(mod_FCBetterThanWolves.fcAnchor);
    ...
    public void ForceStopByPlatform()
    {
        if (!this.isDead)
        {
            ...
            if (this.motionY > 0.0D)
            {
                ...
                if (var4 == mod_FCBetterThanWolves.fcRopeBlock.blockID)
                {
                    ((FCBlockRope)((FCBlockRope)mod_FCBetterThanWolves.fcRopeBlock)).BreakRope(this.worldObj, var1, var2, var3);
                }
            }
    ...
    private void ConvertToBlock(int var1, int var2, int var3)
    {
        ...
        {
            if (var5 == mod_FCBetterThanWolves.fcRopeBlock.blockID)
            {
                if (!this.ReturnRopeToPulley())
                {
                    FCUtilsItem.EjectSingleItemWithRandomOffset(this.worldObj, var1, var2, var3, mod_FCBetterThanWolves.fcRopeItem.shiftedIndex, 0);
                }
            }
            else if (!Block.blocksList[var5].blockMaterial.isSolid())
            {
                Block.blocksList[var5].dropBlockAsItem(this.worldObj, var1, var2, var3, this.worldObj.getBlockMetadata(var1, var2, var3), 0);
            }
            else
            {
                var4 = false;
        ...
        if (var4)
        {
            this.worldObj.setBlockWithNotify(var1, var2, var3, mod_FCBetterThanWolves.fcAnchor.blockID);
            ((FCBlockAnchor)((FCBlockAnchor)mod_FCBetterThanWolves.fcAnchor)).SetFacing(this.worldObj, var1, var2, var3, 1);
        }
        else
        {
            FCUtilsItem.EjectSingleItemWithRandomOffset(this.worldObj, var1, var2, var3, mod_FCBetterThanWolves.fcAnchor.blockID, 0);
        }
    ...
    public boolean ReturnRopeToPulley()
    {
        ...
        if (var1 == mod_FCBetterThanWolves.fcPulley.blockID)
        {
