...
public abstract class FCTileEntityCookingVessel extends TileEntity implements IInventory, FCITileEntityDataPacketHandler
{
    ...
    public int GetCurrentFireFactor()
    {
        ...
        {
            var1 = 5;
            int var2 = Block.fire.blockID;

            if (this.m_iFireUnderType == 2)
            {
                var2 = mod_FCBetterThanWolves.fcStokedFire.blockID;
            }

            int var3 = this.yCoord - 1;

            for (int var4 = this.xCoord - 1; var4 <= this.xCoord + 1; ++var4)
            {
                for (int var5 = this.zCoord - 1; var5 <= this.zCoord + 1; ++var5)
                {
                    if ((var4 != this.xCoord || var5 != this.zCoord) && this.worldObj.getBlockId(var4, var3, var5) == var2)
                    {
                        ++var1;
                    }
                }
    ...
    public void ValidateFireUnderType()
    {
        ...
        else if (var2 == mod_FCBetterThanWolves.fcStokedFire.blockID)
        {
            var1 = 2;
        }
    ...
    {
        if (var1 != null && var1.GetCraftingResult(this) != null)
        {
    ...
    {
        return FCUtilsInventory.GetFirstOccupiedStackOfItem(this, mod_FCBetterThanWolves.fcHellfireDust.shiftedIndex) >= 0 || FCUtilsInventory.GetFirstOccupiedStackOfItem(this, Block.tnt.blockID) >= 0 || FCUtilsInventory.GetFirstOccupiedStackOfItem(this, Item.gunpowder.shiftedIndex) >= 0;
    }

    private void BlowUp()
    {
        int var1 = FCUtilsInventory.CountItemsInInventory(this, mod_FCBetterThanWolves.fcHellfireDust.shiftedIndex, -1);
        float var2 = (float)var1 * 10.0F / 64.0F;
        var2 += (float)FCUtilsInventory.CountItemsInInventory(this, Item.gunpowder.shiftedIndex, -1) * 10.0F / 64.0F;
        ...
        this.worldObj.createExplosion((Entity)null, (double)this.xCoord, (double)this.yCoord, (double)this.zCoord, var2);
    }

    private void AttemptToEjectStackFromInv(int var1)
    {
        int var2 = FCUtilsInventory.GetFirstOccupiedStackNotOfItem(this, Item.brick.shiftedIndex);
