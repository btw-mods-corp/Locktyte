...
public class EntityAIVillagerMate extends EntityAIBase
{
    ...
    private void giveBirth()
    {
        ...
        this.worldObj.playSoundAtEntity(this.villagerObj, "random.hurt", 1.0F, 2.0F);
        this.worldObj.playAuxSFX(2222, MathHelper.floor_double(var1.posX), MathHelper.floor_double(var1.posY), MathHelper.floor_double(var1.posZ), 0);
    }
}
