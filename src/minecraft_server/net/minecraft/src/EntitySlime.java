...
public class EntitySlime extends EntityLiving implements IMob
{
    ...
    public boolean getCanSpawnHere()
    {
        ...
        else if ((this.getSlimeSize() == 1 || this.worldObj.difficultySetting > 0) && this.rand.nextInt(10) == 0 && var1.getRandomWithSeed(987234911L).nextInt(10) == 0 && this.posY < 40.0D)
        {
            int var2 = MathHelper.floor_double(this.posX);
            int var3 = MathHelper.floor_double(this.boundingBox.minY);
            int var4 = MathHelper.floor_double(this.posZ);
            int var5 = this.worldObj.getBlockId(var2, var3 - 1, var4);
            return mod_FCBetterThanWolves.fcLimitSlimeSpawning && var5 != Block.dirt.blockID && var5 != Block.stone.blockID ? false : super.getCanSpawnHere();
        }
        else
        {
            return false;
    ...
    public void CheckForScrollDrop()
    {
        ...
        {
            ItemStack var1 = new ItemStack(mod_FCBetterThanWolves.fcArcaneScroll, 1, Enchantment.protection.effectId);
