...
public class FCExplosionMining
{
    ...
    private void DestroyBlocks()
    {
        ...
        if (var4 <= 0 || Block.blocksList[var4].getExplosionResistance((Entity)null) < 20.0F)
        {
            ...
            if (var6 > 0 && Block.blocksList[var6].getExplosionResistance((Entity)null) >= 20.0F)
            {
        ...
        for (int var4 = var1 - 1; var4 <= var1 + 1; ++var4)
        {
            for (int var5 = var2 - 1; var5 <= var2 + 1; ++var5)
            {
                for (int var6 = var3 - 1; var6 <= var3 + 1; ++var6)
                {
                    ...
                    if (var7 > 0 && Block.blocksList[var7].getExplosionResistance((Entity)null) < 20.0F)
                    {
    ...
    private void DamageEntities()
    {
        ...
        List var8 = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)null, AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double)var2, (double)var4, (double)var6, (double)var3, (double)var5, (double)var7));
        ...
        for (int var10 = 0; var10 < var8.size(); ++var10)
        {
            ...
            if (var12 <= 1.0D)
            {
                ...
                if (var11 instanceof EntityItem)
                {
                    ...
                    int var27 = var26.item.itemID;

                    if (var27 != Item.coal.shiftedIndex && var27 != Item.redstone.shiftedIndex && var27 != Item.dyePowder.shiftedIndex && var27 != Item.flint.shiftedIndex && var27 != Block.oreGold.blockID && var27 != Block.oreIron.blockID)
                    {
                        ...
                        var11.attackEntityFrom(DamageSource.explosion, var28);
                    }
                }
                else
                {
                    var11.attackEntityFrom(DamageSource.explosion, (int)((var24 * var24 + var24) / 2.0D * 8.0D * (double)var1 + 1.0D));
                }
    ...
    private void DestroyBlock(int var1, int var2, int var3)
    {
        ...
        if (var4 > 0)
        {
            ...
            {
                Block.blocksList[var4].dropBlockAsItem_do(this.worldObj, var1, var2, var3, new ItemStack(Block.gravel.blockID, 1, 0));
            }
            else
            {
                Block.blocksList[var4].dropBlockAsItem(this.worldObj, var1, var2, var3, this.worldObj.getBlockMetadata(var1, var2, var3), 0);
            }

            Block.blocksList[var4].onBlockDestroyedByExplosion(this.worldObj, var1, var2, var3);
