...
public class NetServerHandler extends NetHandler
{
    ...
    public void handleFlying(Packet10Flying par1Packet10Flying)
    {
        ...
        if (!this.playerEntity.playerConqueredTheEnd)
        {
            ...
            if (this.hasMoved)
            {
                ...
                if (!this.mcServer.isFlightAllowed() && !this.playerEntity.theItemInWorldManager.isCreative() && !var2.isAABBNonEmpty(var33) && var2.checkIfAABBIsClearExcludingEntity(var33, this.playerEntity))
                {
                    if (var29 >= -0.03125D)
                    {
    ...
    public void handleBlockDig(Packet14BlockDig par1Packet14BlockDig)
    {
        ...
        {
            boolean var3 = var2.disableSpawnProtection = var2.provider.dimensionId != 0 || this.mcServer.getConfigurationManager().areCommandsAllowed(this.playerEntity.username) || this.mcServer.isSinglePlayer();
            boolean var4 = false;
    ...
    public void handlePlace(Packet15Place par1Packet15Place)
    {
        ...
        boolean var9 = var2.disableSpawnProtection = var2.provider.dimensionId != 0 || this.mcServer.getConfigurationManager().areCommandsAllowed(this.playerEntity.username) || this.mcServer.isSinglePlayer();
    ...
    public void handleClientInfo(Packet204ClientInfo par1Packet204ClientInfo)
    {
        ...
        {
            this.playerEntity.playerNetServerHandler.sendPacket(new Packet3Chat("\u00a74" + "WARNING: You do not currently have Better Than Wolves installed on your system."));
            this.playerEntity.playerNetServerHandler.sendPacket(new Packet3Chat("\u00a74" + "This server requires all clients to have Better Than Wolves version " + "4.16"));
            logger.info(this.playerEntity.username + " logged in without BTW installed");
        }
    }
            ...
            for (int var12 = var9; var12 < var10; ++var12)
            {
                if (var1.blockExists(var11, 64, var12))
                {
                    for (int var13 = var7 - 1; var13 < var8; ++var13)
                    {
                        ...
                        if (var14 != null)
                        {
                            var14.addCollidingBlockToList(var1, var11, var13, var12, var3, var4, var2);
                        }
                    }
                }
            }
