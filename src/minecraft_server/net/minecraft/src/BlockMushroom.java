...
public class BlockMushroom extends BlockFlower
{
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (par1World.getBlockId(par2, par3 - 1, par4) == Block.mycelium.blockID && par5Random.nextInt(50) == 0)
        {
            this.fertilizeMushroom(par1World, par2, par3, par4, par5Random);
        }
    }
    ...
    public boolean canBlockStay(World par1World, int par2, int par3, int par4)
    {
        if (par3 >= 0 && par3 < 256)
        {
            ...
            return var5 == Block.mycelium.blockID || par1World.getFullBlockLightValue(par2, par3, par4) < 13 && (this.canThisPlantGrowOnThisBlockID(var5) || FCUtilsMisc.CanPlantGrowOnBlock(par1World, par2, par3 - 1, par4, this));
        }
        else
        {
            return false;
