...
public class TileEntityFurnace extends TileEntity implements IInventory
{
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            return var2 instanceof ItemTool && ((ItemTool)var2).func_77861_e().equals("WOOD") ? 200 : (var2 instanceof ItemSword && ((ItemSword)var2).func_77825_f().equals("WOOD") ? 200 : (var2 instanceof ItemHoe && ((ItemHoe)var2).func_77842_f().equals("WOOD") ? 200 : (var1 != Item.stick.shiftedIndex ? (var1 != Item.coal.shiftedIndex ? (var1 != Item.bucketLava.shiftedIndex ? (var1 != Block.sapling.blockID ? (var1 != Item.blazeRod.shiftedIndex ? mod_FCBetterThanWolves.m_instance.addFuel(par0ItemStack.itemID, par0ItemStack.getItemDamage()) : 2400) : 100) : 20000) : 1600) : 100)));
        }
    }
