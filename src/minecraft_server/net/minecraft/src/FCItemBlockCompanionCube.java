...
public class FCItemBlockCompanionCube extends ItemBlock
{
    public FCItemBlockCompanionCube(int var1)
    {
        ...
        this.setItemName("fcCompanionCube");
    }
    ...
    {
        return var1.getItemDamage() > 0 ? super.getItemName() + "." + "slab" : super.getItemName() + "." + "cube";
    }
    ...
    public boolean canCombineWithBlock(World var1, int var2, int var3, int var4, int var5)
    {
        ...
        if (this.getIsSlab(var5) && var6 == mod_FCBetterThanWolves.fcCompanionCube.blockID)
        {
    ...
    public boolean convertToFullBlock(EntityPlayer var1, World var2, int var3, int var4, int var5)
    {
        ...
        if (var6 == mod_FCBetterThanWolves.fcCompanionCube.blockID)
        {
            FCBlockCompanionCube var7 = (FCBlockCompanionCube)((FCBlockCompanionCube)Block.blocksList[var6]);
            ...
            if (var7 != null && var7.GetIsSlab(var2, var3, var4, var5))
            {
                ...
                int var8 = mod_FCBetterThanWolves.fcCompanionCube.blockID;
                byte var9 = 0;
                int var10 = FCUtilsMisc.ConvertPlacingEntityOrientationToBlockFacing(var1);
                int var11 = var7.SetFacingInMetadata(var9, var10);
    ...
    {
        if (var1 == mod_FCBetterThanWolves.fcCompanionCube.blockID)
        {
    ...
    public boolean attemptToCombineWithBlock(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7, boolean var8)
    {
        if (this.canCombineWithBlock(var3, var4, var5, var6, var1.getItemDamage()))
        {
            ...
            if (var10 != null)
            {
                ...
                if ((!var8 || var7 == 1 && !var12 || var7 == 0 && var12) && var3.checkIfAABBIsClear(var10.getCollisionBoundingBoxFromPool(var3, var4, var5, var6)) && this.convertToFullBlock(var2, var3, var4, var5, var6))
                {
                    --var1.stackSize;
                    return true;
                }
