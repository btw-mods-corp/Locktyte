...
public class WorldServer extends World
{
                ...
                if (var21 != null && var21.getNeedsRandomTick())
                {
                    for (int var20 = 0; var20 < 3; ++var20)
                    {
                        ...
                        if (var18 != null && var18.getTickRandomly())
                        {
                            ...
                            if (mod_FCBetterThanWolves.m_bBlocksRequireSeperateRandomUpdates[var17])
                            {
                                ((FCIBlockSeperateRandomUpdates)var18).RandomUpdateTick(this, var14 + var5, var16 + var21.getYLocation(), var15 + var6, this.rand);
                            }
                            else
                            {
    ...
    public void scheduleBlockUpdate(int par1, int par2, int par3, int par4, int par5)
    {
        ...
        {
            if (mod_FCBetterThanWolves.m_bBlocksRequireReliableUpdates[par4])
            {
                var7 = 0;
            }
    ...
    public boolean tickUpdates(boolean par1)
    {
        ...
        else
        {
            ...
            for (int var3 = 0; var3 < var2; ++var3)
            {
                ...
                {
                    var6 = this.getBlockId(var4.xCoord, var4.yCoord, var4.zCoord);

                    if (mod_FCBetterThanWolves.m_bBlocksRequireReliableUpdates[var6] && var6 == var4.blockID && var6 > 0)
                    {
                        this.scheduleBlockUpdate(var4.xCoord, var4.yCoord, var4.zCoord, var6, 200);
                    }
                }
                else
                {
